...
fn context_scope_param_and_context_must_share_isolate() {
  let _setup_guard = setup();
  let mut isolate1 = v8::Isolate::new(Default::default());
  let mut isolate2 = v8::Isolate::new(Default::default());
  let scope1 = &mut v8::HandleScope::new(&mut isolate1);
  let scope2 = &mut v8::HandleScope::new(&mut isolate2);
