...
impl Value {
  ...
  pub fn to_big_int<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToBigInt(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_number<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToNumber(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_string<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToString(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_detail_string<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToDetailString(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_object<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToObject(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_integer<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToInteger(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_uint32<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToUint32(self, &*scope.get_current_context())
      })
    }
  }
  ...
  pub fn to_int32<'s>(
    ...
    unsafe {
      scope.cast_local(|scope| {
        v8__Value__ToInt32(self, &*scope.get_current_context())
      })
    }
  }
