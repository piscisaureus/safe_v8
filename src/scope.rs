...
mod api {
  ...
  impl<'s, P> AsRef<<Self as Deref>::Target> for ContextScope<'s, P>
  where
    Self: Deref,
  {
  ...
  impl<'s, P> AsMut<<Self as Deref>::Target> for ContextScope<'s, P>
  where
    Self: DerefMut,
  {
  ...
  impl<'s, C> AsRef<<Self as Deref>::Target> for HandleScope<'s, C>
  where
    Self: Deref,
  {
    fn as_ref(&self) -> &<Self as Deref>::Target {
  ...
  impl<'s, C> AsMut<<Self as Deref>::Target> for HandleScope<'s, C>
  where
    Self: DerefMut,
  {
    fn as_mut(&mut self) -> &mut <Self as Deref>::Target {
  ...
  impl<'s, 'e: 's, C> AsRef<<Self as Deref>::Target>
    for EscapableHandleScope<'s, 'e, C>
  where
    Self: Deref,
  {
    fn as_ref(&self) -> &<Self as Deref>::Target {
  ...
  impl<'s, 'e: 's, C> AsMut<<Self as Deref>::Target>
    for EscapableHandleScope<'s, 'e, C>
  where
    Self: DerefMut,
  {
  ...
  impl<'s> AsRef<<Self as Deref>::Target> for CallbackScope<'s>
  where
    Self: Deref,
  {
    fn as_ref(&self) -> &<Self as Deref>::Target {
  ...
  impl<'s> AsMut<<Self as Deref>::Target> for CallbackScope<'s>
  where
    Self: DerefMut,
  {
    fn as_mut(&mut self) -> &mut <Self as Deref>::Target {
